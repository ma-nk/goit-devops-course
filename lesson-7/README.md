# Lesson 6: Helm Charts and Kubernetes Deployment on EKS
...
3.  **EKS**: EKS cluster with managed Node Groups (`t2.micro` instances).
...
4.  **ConfigMap**: Contains database connection settings and environment variables (migrated from lesson-4 docker-compose configuration).
